...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const autoScrollInterval = 12000; // Set the interval time for auto-scrolling (in milliseconds)
    ...
    carouselSlide.addEventListener("mousedown", handleDragStart);
    carouselSlide.addEventListener("mousemove", handleDragMove);
    carouselSlide.addEventListener("mouseup", handleDragEnd);
    carouselSlide.addEventListener("mouseleave", handleDragEnd);
  
    carouselSlide.addEventListener("touchstart", handleDragStart);
    carouselSlide.addEventListener("touchmove", handleDragMove);
    carouselSlide.addEventListener("touchend", handleDragEnd);
    carouselSlide.addEventListener("touchcancel", handleDragEnd);
